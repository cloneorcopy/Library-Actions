...
#     "Referer": "http://libzw.csu.edu.cn/web/seat3?area=10&segment=1319909&day=2021-11-14&startTime=20:11&endTime=23:00",
...
# 第一次访问 -随便哪个页面http://libzw.csu.edu.cn/web/seat3?area=8&segment=1315641&day=2122-3-16&startTime=19:21&endTime=22:11
#           -不需要携带cookie
#           -返回   'Set-Cookie':'PHPSESSID=kv8ab5f268pp5mjld6hmtfuus4; path=/; HttpOnly'
# 获取验证码 -http://libzw.csu.edu.cn/api.php/check
...
# 登录      -http://libzw.csu.edu.cn/api.php/login
#           -需要携带cookie形式1   'Cookie':'PHPSESSID=kv8ab5f268pp5mjld6hmtfuus4; path=/; HttpOnly'
#           -需要携带cookie形式2   'Cookie':'PHPSESSID=kv8ab5f268pp5mjld6hmtfuus4'
...
# 延长cookie和预约 -"http://libzw.csu.edu.cn/api.php/spaces/3787/book"
...
# 获取座位信息 -http://libzw.csu.edu.cn/api.php/check
